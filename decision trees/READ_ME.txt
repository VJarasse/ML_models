######################################################
#                Decision Trees CO395                #
######################################################

In the context of the decision tree coursework for course CO395, you will find in the folder the following material:
 - This "READ_ME.txt" file
 - The raw python code "decision_trees.py"
 - A jupyter notebook "Decision Trees CW - CO395.ipynb"
 - A report "decision_trees_report.pdf"
...
The purpose of the "decision_trees.py" is to be executed in command line:
 ...
 The pdf report "decision_trees_report.pdf" contains explanations about our code, as well as answers to the questions asked in the specifications.
